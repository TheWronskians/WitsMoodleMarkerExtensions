 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignfeedback_witsoj_subplugin extends restore_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/feedback_witsoj');
    ...
    /**
     * Processes one feedback_witsoj element.
     * @param mixed $data
     */
    public function process_assignfeedback_witsoj_grade($data) {
        global $DB;
        ...
        $DB->insert_record('assignfeedback_witsoj', $data);
    }
}
