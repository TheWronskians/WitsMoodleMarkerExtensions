 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_assignfeedback_witsoj_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $subpluginelement = new backup_nested_element('feedback_witsoj',
                                                      null,
        ...
        $subpluginelement->set_source_table('assignfeedback_witsoj',
