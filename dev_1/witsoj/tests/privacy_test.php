...
/**
 * Unit tests for assignfeedback_witsoj.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignfeedback_witsoj_privacy_testcase extends \mod_assign\tests\mod_assign_privacy_testcase {
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('assignfeedback_witsoj');
        $collection = \assignfeedback_witsoj\privacy\provider::get_metadata($collection);
    ...
    public function test_export_feedback_user_data() {
        ...
        \assignfeedback_witsoj\privacy\provider::export_feedback_user_data($exportdata);
    ...
    public function test_delete_feedback_for_context() {
        ...
        $feedbackcomments = $plugin1->get_feedback_witsoj($grade1->id);
        $this->assertNotEmpty($feedbackcomments);
        $feedbackcomments = $plugin1->get_feedback_witsoj($grade2->id);
        $this->assertNotEmpty($feedbackcomments);

        // Delete all comments for this context.
        $requestdata = new \mod_assign\privacy\assign_plugin_request_data($context, $assign);
        assignfeedback_witsoj\privacy\provider::delete_feedback_for_context($requestdata);
    ...
    public function test_delete_feedback_for_grade() {
        ...
        assignfeedback_witsoj\privacy\provider::delete_feedback_for_grade($requestdata);
